...
const MOCK_DISCOVERY_RACES = {
  'd1': { id:'d1', name:'Parks Half Marathon', date:'September 21, 2026', location:'Bethesda, MD', distance:'13.1', price:'$95', terrain:'Road', elevation:'180ft', estFinishers:1200, registrationUrl:'https://runsignup.com', query:'half marathon running race road crowd runners', description:'A fast, scenic half marathon through the trails and roads of Rock Creek Park and Bethesda. Certified course, chip timing, finisher medals.', cutoffTime:'3:30:00', charity:'Montgomery County Road Runners', weeks:10 },
  'd2': { id:'d2', name:'Suds & Soles 5K', date:'June 13, 2026', location:'Rockville, MD', distance:'5K', price:'$35', terrain:'Road', elevation:'85ft', estFinishers:400, registrationUrl:'https://runsignup.com', query:'5K running race community finish line street', description:'A fun community 5K followed by a post-race celebration. All ages and paces welcome. Finisher pint glass included.', cutoffTime:'1:00:00', charity:'Local Schools', weeks:4 },
  'd3': { id:'d3', name:'Baltimore 10 Miler', date:'June 6, 2026', location:'Baltimore, MD', distance:'10 mi', price:'$65', terrain:'Road', elevation:'210ft', estFinishers:800, registrationUrl:'https://runsignup.com', query:'Baltimore Inner Harbor waterfront running city', description:"A scenic tour through Baltimore's historic neighborhoods and waterfront. The iconic Inner Harbor finish makes this one of the region's most scenic races.", cutoffTime:'2:30:00', charity:'Baltimore Running Festival Foundation', weeks:8 },
  'd4': { id:'d4', name:'Annapolis Run Across the Bay', date:'October 12, 2026', location:'Annapolis, MD', distance:'10K', price:'$55', terrain:'Bridge/Road', elevation:'140ft', estFinishers:600, registrationUrl:'https://runsignup.com', query:'Chesapeake Bay Bridge Maryland aerial water scenic', description:'One of the most unique race experiences anywhere — running across the Chesapeake Bay Bridge with stunning water views in every direction.', cutoffTime:'2:00:00', charity:'Anne Arundel Medical Center', weeks:6 },
  'd5': { id:'d5', name:'DC Half Marathon', date:'March 15, 2026', location:'Washington, DC', distance:'13.1', price:'$110', terrain:'Road', elevation:'190ft', estFinishers:14000, registrationUrl:'https://runsignup.com', query:'Washington DC Capitol monument running race road', description:'A spring classic through the monuments of the national capital. The course takes runners past the Lincoln Memorial, Capitol, and National Mall.', cutoffTime:'3:30:00', charity:'American Heart Association', weeks:10 },
  'd6': { id:'d6', name:'Frederick Festival 5K', date:'May 2, 2026', location:'Frederick, MD', distance:'5K', price:'$30', terrain:'Road', elevation:'95ft', estFinishers:300, registrationUrl:'https://runsignup.com', query:'Frederick Maryland historic brick downtown street', description:'A fun community 5K through the historic streets of downtown Frederick. Finisher medal and post-race festival included.', cutoffTime:'1:00:00', charity:'Frederick Family Health', weeks:4 },
  '101': { id:'101', name:'Marine Corps Marathon', date:'October 29, 2026', location:'Washington, DC', distance:'26.2', price:'$140', terrain:'Road', elevation:'912ft', estFinishers:19000, registrationUrl:'https://marinemarathon.com', query:'Washington DC marathon runners National Mall crowd', description:"One of the largest marathons in the US, run through the monuments of the nation's capital. Finishers receive the iconic Semper Fidelis medal from a Marine.", cutoffTime:'6:00:00', charity:'Marine Corps Scholarship Foundation', weeks:16, registered:true },
  '102': { id:'102', name:'IRONMAN 70.3 Atlantic City', date:'September 13, 2026', location:'Atlantic City, NJ', distance:'70.3', price:'$350', terrain:'Road/Water', elevation:'1200ft', estFinishers:2000, registrationUrl:'https://ironman.com', query:'triathlon ocean swim wetsuit athletes open water', description:'A full IRONMAN 70.3 featuring a 1.2-mile ocean swim, 56-mile bike, and 13.1-mile run along the famous boardwalk.', cutoffTime:'8:30:00', charity:'IRONMAN Foundation', weeks:20, registered:true },
  '103': { id:'103', name:'Cherry Blossom 10 Miler', date:'April 8, 2026', location:'Washington, DC', distance:'10 mi', price:'$110', terrain:'Road', elevation:'190ft', estFinishers:14000, registrationUrl:'https://cherryblossom.org', query:'cherry blossom Washington DC Tidal Basin spring pink', description:'The iconic DC spring race around the Tidal Basin as cherry blossoms peak. One of the most scenic races in the country.', cutoffTime:'2:30:00', charity:'American Liver Foundation', weeks:10, registered:true },
}
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#f4f5f7', fontFamily:"'Barlow',sans-serif", '--rc': colors.primary }}>
      ...
      <div style={{ position:'sticky', top:0, zIndex:50, background:'rgba(255,255,255,0.96)', backdropFilter:'blur(8px)', borderBottom:'1px solid #e8eaed', boxShadow:'0 1px 8px rgba(27,42,74,0.06)', display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 40px', height:'56px' }}>
        ...
        <button onClick={() => window.open(race.registrationUrl, '_blank')}
          style={{ padding:'7px 20px', border:'none', borderRadius:'8px', background: race.registered ? '#1a7a38' : colors.primary, fontFamily:"'Barlow Condensed',sans-serif", fontSize:'11px', fontWeight:600, letterSpacing:'1.5px', color:'#fff', cursor:'pointer', textTransform:'uppercase', transition:'opacity 0.15s' }}
      ...
      <div style={{ height:'420px', position:'relative', background:'#1B2A4A', overflow:'hidden' }}>
        ...
        {race.registered && (
          <div style={{ position:'absolute', top:24, right:24, background:'rgba(26,122,56,0.9)', borderRadius:'8px', padding:'6px 16px', display:'flex', alignItems:'center', gap:'8px', zIndex:3 }}>
      ...
      <div style={{ background:'#fff', borderBottom:'1px solid #e8eaed' }}>
        <div style={{ maxWidth:'1200px', margin:'0 auto', display:'grid', gridTemplateColumns:'repeat(4,1fr)', padding:'0 40px' }}>
          {[{ label:'Entry Fee', value:race.price },{ label:'Terrain', value:race.terrain },{ label:'Elevation', value:race.elevation },{ label:'Est. Finishers', value:race.estFinishers?.toLocaleString() }].map((s,i) => (
            <div key={i} style={{ padding:'20px 0', textAlign:'center', borderRight:i<3?'1px solid #e8eaed':'none' }}>
            ...
            <div style={{ display:'grid', gridTemplateColumns:'2fr 1fr', gap:'28px', alignItems:'start' }}>
              <div>
                <div style={{ background:'#fff', borderRadius:'16px', padding:'28px', border:'1px solid #e8eaed', marginBottom:'24px' }}>
                  ...
                  <p style={{ fontFamily:"'Barlow',sans-serif", fontSize:'15px', color:'#4a5568', lineHeight:1.8, fontWeight:300 }}>{race.description}</p>
                </div>
                <div style={{ background:'#fff', borderRadius:'16px', padding:'28px', border:'1px solid #e8eaed' }}>
                  ...
                  <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'12px' }}>
                    {[{ label:'Distance', value:race.distance },{ label:'Date', value:race.date },{ label:'Location', value:race.location },{ label:'Entry Fee', value:race.price },{ label:'Cutoff Time', value:race.cutoffTime },{ label:'Charity', value:race.charity }].map(item => (
              ...
              <div>
                ...
                <div style={{ background:'#1B2A4A', borderRadius:'16px', padding:'28px', marginBottom:'18px', textAlign:'center' }}>
                  ...
                  {race.registered ? (
                    <>
                      <div style={{ display:'inline-flex', alignItems:'center', gap:'6px', background:'rgba(26,122,56,0.2)', border:'1px solid rgba(26,122,56,0.4)', borderRadius:'8px', padding:'6px 14px', marginBottom:'12px' }}>
                        <div style={{ width:6, height:6, borderRadius:'50%', background:'#6ee387' }} />
                        <span style={{ fontFamily:"'Barlow Condensed',sans-serif", fontSize:'10px', fontWeight:700, letterSpacing:'2px', color:'#6ee387', textTransform:'uppercase' }}>You're Registered!</span>
                      </div>
                      <div style={{ fontFamily:"'Barlow Condensed',sans-serif", fontSize:'12px', color:'rgba(255,255,255,0.4)', lineHeight:1.6 }}>Already registered. Check your email for confirmation details.</div>
                    </>
                  ) : (
                    <>
                      <div style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:'32px', color:colors.primary, letterSpacing:'1px', marginBottom:'4px' }}>{race.price}</div>
                      <div style={{ fontFamily:"'Barlow Condensed',sans-serif", fontSize:'10px', color:'rgba(255,255,255,0.4)', letterSpacing:'1px', marginBottom:'18px' }}>Registration fee</div>
                      <button onClick={() => window.open(race.registrationUrl, '_blank')} style={{ width:'100%', padding:'13px', border:'none', borderRadius:'10px', background:colors.primary, fontFamily:"'Barlow Condensed',sans-serif", fontSize:'13px', fontWeight:600, letterSpacing:'2px', color:'#fff', cursor:'pointer', textTransform:'uppercase', transition:'opacity 0.15s' }}
                        onMouseEnter={e => e.currentTarget.style.opacity='0.85'} onMouseLeave={e => e.currentTarget.style.opacity='1'}>
                ...
                {/* Training estimate */}
                <div style={{ background:'#fff', borderRadius:'12px', padding:'20px', border:'1px solid #e8eaed', borderTop:`3px solid ${colors.primary}` }}>
                  ...
                  <div style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:'40px', color:'#1B2A4A', letterSpacing:'1px', lineHeight:1 }}>{race.weeks} Weeks</div>
                  <div style={{ fontFamily:"'Barlow Condensed',sans-serif", fontSize:'11px', color:'#9aa5b4', marginTop:'6px', lineHeight:1.5 }}>Based on your experience level and race history</div>
                </div>
              </div>
            </div>
          </div>
