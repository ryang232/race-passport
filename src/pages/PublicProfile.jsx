...
const MOCK_PROFILE = {
  ...
  bio: "Running is the only sport where a 4-hour finish is still a brag.",
  since: '2019',
  stats: { races:14, miles:341, prs:3, states:6 },
  races: [
    { id:1, distance:'26.2', name:'Marine Corps Marathon', location:'Arlington, VA', month:'Oct', year:'2024', time:'4:02:11', pr:true },
    { id:2, distance:'70.3', name:'IRONMAN 70.3', location:'Atlantic City, NJ', month:'Sept', year:'2024', time:'5:41:22', pr:false },
    { id:3, distance:'13.1', name:"Rock 'N' Roll Half", location:'Nashville, TN', month:'Apr', year:'2023', time:'1:52:04', pr:true },
    { id:4, distance:'50K', name:'Seneca Creek Trail Ultra', location:'Gaithersburg, MD', month:'Mar', year:'2022', time:'6:14:38', pr:false },
    { id:5, distance:'10K', name:'Broad Street Run', location:'Philadelphia, PA', month:'May', year:'2023', time:'57:14', pr:false },
    { id:6, distance:'5K', name:'Turkey Trot', location:'Chicago, IL', month:'Nov', year:'2023', time:'24:02', pr:false },
    { id:7, distance:'5K', name:'Hot Cider Hustle', location:'Washington, DC', month:'Nov', year:'2022', time:'24:33', pr:false },
  ],
  prs: [
    { distance:'5K', time:'22:14', color:'#1E5FA8' },
    { distance:'10K', time:'46:38', color:'#1E5FA8' },
    { distance:'10 Mile', time:'1:18:22', color:'#1E5FA8' },
    { distance:'Half', time:'1:52:04', color:'#1E5FA8' },
    { distance:'Marathon', time:'4:02:11', color:'#C9A84C' },
    { distance:'70.3', time:'5:41:22', color:'#B83232' },
  ],
  gear: [
    ...
    { id:5, category:'Headphones', brand:'Shokz', model:'OpenRun Pro', color:'Black', url:'https://shokz.com', note:'Never race without them' },
  ],
}
