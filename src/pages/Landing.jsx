...
export default function Landing() {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .lp-nav-signup {
        ...
        background: var(--navy); border: none; cursor: pointer; padding: 10px 22px;
        transition: background 0.2s;
      }
      .lp-nav-signup:hover { background: var(--gold); }
      .lp-hero {
        min-height: 100vh; display: flex; flex-direction: column;
        justify-content: flex-end; padding: 80px 48px 72px;
        position: relative; overflow: hidden;
      }
      .lp-hero-ticker {
        position: absolute; top: 50%; transform: translateY(-55%); left: 0;
      ...
      .lp-ticker-item {
        ...
        color: transparent; -webkit-text-stroke: 1px rgba(27,42,74,0.06);
        line-height: 1; user-select: none; padding: 0 40px; flex-shrink: 0;
      }
      ...
      .lp-hero-eyebrow {
        ...
        opacity: 0; animation: lpSlideUp 0.8s ease 0.3s forwards;
      }
      ...
      .lp-hero-title {
        ...
        opacity: 0; animation: lpSlideUp 0.8s ease 0.5s forwards;
      }
      .lp-hero-title span { color: var(--gold); }
      .lp-hero-sub {
        margin-top: 28px; font-size: clamp(13px, 1.6vw, 18px); font-weight: 300;
        letter-spacing: 0.12em; text-transform: uppercase; color: rgba(27,42,74,0.5);
        opacity: 0; animation: lpSlideUp 0.8s ease 0.7s forwards; line-height: 1.8;
      }
      .lp-hero-sub em { color: var(--navy); font-style: normal; font-weight: 500; }
      .lp-hero-actions {
        margin-top: 48px; display: flex; align-items: center; gap: 28px;
        opacity: 0; animation: lpSlideUp 0.8s ease 0.9s forwards;
      }
      .lp-btn-primary {
        font-family: 'Barlow Condensed', sans-serif; font-size: 13px; font-weight: 600;
        letter-spacing: 0.25em; text-transform: uppercase; background: var(--navy);
        color: var(--white); border: none; padding: 18px 42px;
        text-decoration: none; display: inline-block; transition: all 0.3s ease; cursor: pointer;
      }
      ...
      .lp-btn-ghost {
        ...
        letter-spacing: 0.2em; text-transform: uppercase; color: rgba(27,42,74,0.45);
        text-decoration: none; display: flex; align-items: center; gap: 10px; transition: color 0.3s ease;
      }
      ...
      .lp-hero-scroll {
        ...
        opacity: 0; animation: lpFadeIn 1s ease 1.5s forwards;
      }
      ...
      .lp-ecosystem { padding: 120px 48px; background: var(--navy); border-top: 1px solid rgba(255,255,255,0.06); }
      .lp-ecosystem-inner { max-width: 1200px; margin: 0 auto; }
      .lp-ecosystem-tag { font-family: 'Barlow Condensed', sans-serif; font-size: 10px; font-weight: 600; letter-spacing: 0.4em; text-transform: uppercase; color: var(--gold); margin-bottom: 32px; display: flex; align-items: center; gap: 14px; }
      .lp-ecosystem-tag::before { content: ''; width: 24px; height: 1px; background: var(--gold); }
      .lp-ecosystem-title { font-family: 'Bebas Neue', sans-serif; font-size: clamp(48px, 7vw, 96px); line-height: 0.9; color: var(--white); margin-bottom: 72px; }
      .lp-ecosystem-title span { color: var(--gold); }
      .lp-ecosystem-grid { display: grid; grid-template-columns: repeat(3, 1fr); border-top: 1px solid rgba(255,255,255,0.08); }
      .lp-eco-card { padding: 48px 40px 48px 0; border-right: 1px solid rgba(255,255,255,0.08); }
      .lp-eco-card:nth-child(2) { padding-left: 40px; }
      .lp-eco-card:nth-child(3) { padding-left: 40px; border-right: none; }
      .lp-eco-brand { font-family: 'Barlow Condensed', sans-serif; font-size: 11px; font-weight: 600; letter-spacing: 0.3em; text-transform: uppercase; color: rgba(255,255,255,0.3); margin-bottom: 16px; }
      .lp-eco-owns { font-family: 'Bebas Neue', sans-serif; font-size: clamp(28px, 3vw, 42px); letter-spacing: 0.04em; color: var(--white); margin-bottom: 16px; line-height: 1; }
      .lp-eco-owns.highlight { color: var(--gold); }
      .lp-eco-desc { font-size: 14px; font-weight: 300; line-height: 1.8; color: rgba(255,255,255,0.4); }
    ...
    // Hero ticker parallax on scroll
  ...
  // Triple-click logo — always active, opens login regardless of LIVE flag
    ...
    <div style={{ fontFamily: "'Barlow',sans-serif" }} onKeyDown={e => { if (e.key === 'Escape') closeModal() }}>
      ...
      <section className="lp-hero" id="top">
        ...
        <div className="lp-hero-content">
          ...
          <h1 className="lp-hero-title">The Shrine<br/>of the <span>Destination.</span></h1>
          <p className="lp-hero-sub">
            <em>Strava owns the journey. Runna owns the coaching.</em><br/>
            Race Passport owns the destination.
          </p>
      ...
      <section className="lp-section-how" id="how">
        <div className="lp-how-inner">
          ...
          <div className="lp-how-steps">
            {[
              { n:'Step 01', t:'Build Your Passport',    d:'Fill out your profile once — name, running background, shirt size. Your identity is set. Race Passport remembers everything so you never have to fill out a form again.' },
              { n:'Step 02', t:'Import Your Races',      d:'Pull in your complete race history. Every 5K, every marathon, every triathlon — imported and organized into your passport in seconds.' },
              { n:'Step 03', t:'Relive Every Race',      d:'Each race gets its own page. Add photos, tell your story, log your gear, link your Strava activity for maps and splits. Your finish line, preserved forever.' },
              { n:'Step 04', t:'Get Your Pacer Grade',   d:'Our AI coach Pacer analyzes every race in your history — your pacing, your training, your performance — and grades each one. Your career score tracks your journey as an athlete.' },
              { n:'Step 05', t:'Discover What\'s Next',  d:'Browse thousands of upcoming races on an interactive map. Find your next destination and add it to your passport before you even toe the start line.' },
            ].map((s,i) => (
      ...
      <section className="lp-ecosystem">
        <div className="lp-ecosystem-inner">
          <div className="lp-ecosystem-tag">Where We Fit</div>
          <h2 className="lp-ecosystem-title">Every Race<br/>Has a <span>Story.</span></h2>
          <div className="lp-ecosystem-grid">
            <div className="lp-eco-card lp-reveal">
              <div className="lp-eco-brand">Strava</div>
              <div className="lp-eco-owns">Owns the Journey</div>
              <p className="lp-eco-desc">Every training run, every daily mile, every early morning out the door. The preparation that gets you to the start line.</p>
            </div>
            <div className="lp-eco-card lp-reveal">
              <div className="lp-eco-brand">Runna</div>
              <div className="lp-eco-owns">Owns the Coaching</div>
              <p className="lp-eco-desc">Structured plans, pacing guidance, and the training intelligence that turns a runner into a racer ready for race day.</p>
            </div>
            <div className="lp-eco-card lp-reveal">
              <div className="lp-eco-brand">Race Passport</div>
              <div className="lp-eco-owns highlight">Owns the Destination</div>
              <p className="lp-eco-desc">The finish line. The stamp. The permanent record of what all that training was for. Your racing identity, built race by race, forever.</p>
            </div>
          </div>
        </div>
      </section>

      {/* FOR RACERS / FOR RACE DIRECTORS */}
      <div className="lp-sides-wrapper">
        <section className="lp-sides">
          <div className="lp-reveal">
            <div className="lp-side-tag">For Racers</div>
            <h3 className="lp-side-title">Your Racing<br/>Life. One<br/>Place.</h3>
            <ul className="lp-side-list">
              {[
                'Every race you\'ve ever run, organized and beautifully presented',
                'Personal race pages — photos, story, gear, Strava map, splits',
                'Pacer AI grades every race and tracks your career score',
                'Collectible stamps for every finish line you\'ve ever crossed',
                'A public passport URL that lives in your Instagram bio',
                'Discover upcoming races on an interactive map',
                'The Wall — share your story and inspire other athletes',
              ].map((item,i) => <li key={i}>{item}</li>)}
            </ul>
          </div>
          <div className="lp-reveal">
            <div className="lp-side-tag">Coming in V2</div>
            <h3 className="lp-side-title">Race<br/>Directors.<br/>Zero Risk.</h3>
            <ul className="lp-side-list">
              {[
                'List your race in front of every Race Passport athlete',
                'Keep using RunSignUp — nothing changes about how you run registration',
                'Race Passport sends runners to your registration page',
                'Design a custom stamp for your race — every finisher takes it home permanently',
                'Your race lives in thousands of athlete passports forever',
                'Flat annual fee — no per-registrant cuts, ever',
              ].map((item,i) => <li key={i}>{item}</li>)}
            </ul>
          </div>
        </section>
      ...
      <section className="lp-showcase">
        <div className="lp-showcase-inner lp-reveal">
          ...
          <p className="lp-showcase-desc">
            Every Race Passport member gets a <strong>public profile</strong> — a living digital passport that tells your story as a runner. Your stamps, your stats, your PRs.<br/><br/>
            Link it in your Instagram bio. Send it to friends and family. <strong>Your racing identity, in one link, forever.</strong>
          </p>
      ...
      <section className="lp-waitlist" id="waitlist">
        <div className="lp-waitlist-inner">
          ...
          <p className="lp-waitlist-sub">
            {LIVE
              ? 'Your passport is ready. Create your account and start building your racing identity.'
              : 'Be first when we launch.\nRacers and race directors both welcome.'
            }
          </p>
          {LIVE ? (
